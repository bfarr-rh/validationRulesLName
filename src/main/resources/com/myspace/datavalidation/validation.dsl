...
[condition][location] - with name matching the regular expression {expression}=lastName matches "{expression}"
[condition][location] - with name not matching the regular expression {expression}=lastName not matches "{expression}"
[condition][location] - with name longer than {number} characters long=lastName.length() > {number}
